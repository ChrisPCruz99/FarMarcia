...
import org.generation.farmarcia.repository.ProdutosRepository;
...
public class ProdutosController {
	...
	/*@GetMapping("/dataValidade/{dataValidade}")
	public ResponseEntity<List<Produtos>> 
	GetByDataValidade(@PathVariable LocalDateTime dataValidade){
		return ResponseEntity.ok
